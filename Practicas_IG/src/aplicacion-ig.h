...
class AplicacionIG
{
   ...
   unsigned ind_escena_act = 0;   //Lo he modificado para empezar viendo la escena 
                                 //que me interesa, en concreto la de la práctica 
                                 //que estoy haciendo    
   ...
   ModosVisu modo_visu = ModosVisu::lineas ;
