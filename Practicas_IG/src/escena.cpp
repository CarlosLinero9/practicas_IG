...
Escena::Escena()
{
   ...
   material_ini = new Material(0.5f, 0.4f, 0.3f, 1.5f);
   ...
   camaras.push_back(new Camara3Modos(true, *(new vec3({0.00001, 10.0, 0.0})), 1.0, *(new vec3({0.0, 0.0, 0.0})), 70.0));
   camaras.push_back(new Camara3Modos(true, *(new vec3({-3.0, 3.0, 3.0})), 1.0, *(new vec3({0.0, 0.0, 0.0})), 50.0));
   camaras.push_back(new Camara3Modos(false, *(new vec3({0.0, 0.0, -3.0})), 1.0, *(new vec3({0.0, 0.0, 0.0})), 60.0));
   camaras.push_back(new Camara3Modos(false, *(new vec3({3.0, 0.0, 0.0})), 1.0, *(new vec3({0.0, 0.0, 0.0})), 60.0));
   camaras.push_back(new Camara3Modos(false, *(new vec3({0.0, 0.0, 3.0})), 1.0, *(new vec3({0.0, 0.0, 0.0})), 80.0));
...
void Escena::visualizarGL( )
{
   ...
   if ( aplicacionIG->dibujar_aristas && aplicacionIG->modo_visu == ModosVisu::relleno ) 
   {
      ...
      // 
      // ...........
      aplicacionIG->cauce->fijarColor( 0.0, 0.0, 0.0 );
      glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
...
void Escena::visualizarGL_Seleccion(  )
{
   ...
   assert( aplicacionIG != nullptr );
   assert( aplicacionIG->cauce != nullptr );
   Cauce * cauce = aplicacionIG->cauce ; //Descomentar luego
   CError();
...
Escena1::Escena1()
{
   ...
   objetos.push_back(new Triangulo_Boton());
...
Escena2::Escena2()
{
   ...
   objetos.push_back(new MallaRevolPLY("peon.ply", 150));
   objetos.push_back(new Cilindro(12,25));
   objetos.push_back(new Cono(21,20));
   ...
   objetos.push_back(new MallaPLY("goku.ply"));
   objetos.push_back(new MallaPLY("bmo.ply"));
   objetos.push_back(new Esfera(12,12));
   objetos.push_back(new MallaRevolPLY("lata-pcue.ply", 20));
   objetos.push_back(new PiramideEstrellaZ(20));
}
...
Escena3::Escena3()
{
   ...
   // COMPLETAR: práctica 3: añadir resto de objetos a la escena 3
   //
   // Añadir sentencias 'push_back' adicionales para agregar al 
   // array 'objetos' otros objetos de la práctica 3
   // 
   // .......
   //objetos.push_back(new Ejercicio3(2, 0.23));
   objetos.push_back(new BMO());
   objetos.push_back(new GrafoEstrellaX(5));
   objetos.push_back(new GrafoCubos(5, 5));
}
...
Escena4::Escena4()
{
   ...
   // COMPLETAR: práctica 4: añadir resto de objetos a la escena 4
   //
   // Añadir sentencias 'push_back' adicionales para agregar al 
   // array 'objetos' otros objetos de la práctica 4
   // 
   // .......
   objetos.push_back(new LataPeones());
   objetos.push_back(new NodoCubo24());
   objetos.push_back(new NodoDiscoP4E1());
   objetos.push_back(new NodoDiscoP4E2());
...
Escena5::Escena5()
{
   ...
   // COMPLETAR: práctica 5: añadir resto de objetos a la escena 4
   //
   // Añadir sentencias 'push_back' adicionales para agregar al 
   // array 'objetos' otros objetos de la práctica 5
   // 
   // .......
   ...
   //Lo incluyo, pero no funciona la seleccion
   objetos.push_back(new GrafoPiramide());
